...
def api1():
    ...
    st.sidebar.header("API 1: Search aircraft in Location")
...
def api2():
    st.header("API 2: Get aircrafts coordinate in picture")
    st.sidebar.header("API 2: Get aircrafts coordinate in picture")
    fun2val1 = st.sidebar.text_input("image_id", max_chars= 50)
    if st.sidebar.button("Select"):
        st.write('Finish2')
    
def api3():
    st.header("API 3: Desplay the big or small aircraft in picture")
    st.sidebar.header("API 3: Desplay the big or small aircraft in picture")
...
def api4():
    st.header("API 4: Desplay the big or small aircraft in picture")
    st.sidebar.header("API 4: Desplay the big or small aircraft in picture")
    fun4val1 = st.sidebar.text_input("image id", max_chars= 50)
    if st.sidebar.button("Select"):
        st.write('Finish4')
    
def api5():
    st.header("API 5: Search numbers of aircrafts")
    st.sidebar.header("API 5: Search numbers of aircrafts")
...
def api6():
    st.header("API 6: Search maximum aircrafts of picture")
    st.sidebar.header("API 6: Search maximum aircrafts of picture")
    fun6val1 = st.sidebar.number_input("number of image (Pick a number between (1,10))",1 ,10)
    if st.sidebar.button("Select"):
        st.write('Finish6')
    
def api7():
    st.header("API 7: Search maximum truncated aircrafts of picture")
    st.sidebar.header("API 7: Search maximum truncated aircrafts of picture")
